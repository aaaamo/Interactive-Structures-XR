...
IL_0009:
	{
		RuntimeObject* L_1 = ___1_value;
		ThrowHelper_IfNullAndNullsAreIllegalThenThrow_TisSimpleTuple_3_t2683D243897EFFAEBABCB594966AD0B9376A899B_m02112B8D98B760BEFA087F90B1E60D29A994E03A(L_1, (int32_t)((int32_t)15), il2cpp_rgctx_method(method->klass->rgctx_data, 58));
	}
	try
	{
		{
		...
		try
		{
			int32_t L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_m54062E9DE81FC9F67CA5820C1E76AEA7E58BA517(__this, L_3, ((*(SimpleTuple_3_t2683D243897EFFAEBABCB594966AD0B9376A899B*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 59));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
